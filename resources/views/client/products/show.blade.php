                ...
                alt="لپ تاپ ایلین ور">
                        ...
                        <div class="col-sm-6">
                            <ul class="list-unstyled description">
                                <li> <b>برند :</b>
                                    <a href="#"><span itemprop="brand">{{$product->brand->name}} </span></a>
                                </li>
                            ...
                            <ul class="price-box">
                                <li class="price" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    ...
                                    @else
                                        <span itemprop="price">{{number_format ($product->price_whit_discount)}}  تومان
                                    </span>
                                    @endif
                    ...
                    <div class="owl-carousel related_pro owl-theme" style="opacity: 1; display: block;">
                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2040px; left: 0px; display: block;"><div class="owl-item" style="width: 170px;"><div class="product-thumb">
                                        ...
                                        <div class="button-group">
                                            ...
                                            <div class="add-to-links">
                                                <button type="button" data-toggle="tooltip" title="" onclick="" data-original-title="افزودن به علاقه مندی"><i class="fa fa-heart"></i></button>
                                    ...
                                    </div></div><div class="owl-item" style="width: 170px;"><div class="product-thumb">
